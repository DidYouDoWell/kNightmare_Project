	...
	protected new void Awake()
	{
		...
		switch (rand)
		{
			case 1:
                ...
                gameObject.transform.Find("Model").Find("Frame").GetComponent<MeshRenderer>().material.color = Color.red;
                gameObject.transform.Find("Model").Find("Deer").GetComponent<MeshRenderer>().material.color = Color.red;
                break;
			case 2:
                ...
                gameObject.transform.Find("Model").Find("Frame").GetComponent<MeshRenderer>().material.color = Color.blue;
                gameObject.transform.Find("Model").Find("Deer").GetComponent<MeshRenderer>().material.color = Color.blue;
                break;
			case 3:
                ...
                gameObject.transform.Find("Model").Find("Frame").GetComponent<MeshRenderer>().material.color = Color.green;
                gameObject.transform.Find("Model").Find("Deer").GetComponent<MeshRenderer>().material.color = Color.green;
